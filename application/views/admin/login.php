...
<head>
    ...
    <title><?php echo config_item('site_name'); ?> - Admin Login</title>
                ...
                <section class="flexbox-container">
                            ...
                            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                                <div class="card-header border-0">
                                    <div class="card-title text-center">
                                        ...
                                        <h2 class="header_color"><?php echo config_item('site_name').' - Admin';?></h2>
                                    </div>
                  <?php   
                  $success_message = "";
                  $error_message = "";
                  ...
                  <div class="alert alert-danger mt-1" role="alert" style="display: <?php  echo $error_show; ?>;">
                    <strong>Error !</strong> <span class="error_message"><?php echo $error_message; ?></span>
                                ...
                                <div class="card-body">
                                    <form id="admin_login" class="form-horizontal" action="" method="POST" accept-charset="utf-8" novalidate>
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" class="form-control" id="admin_email" name="admin_email" placeholder="Your Email" onkeydown="if (event.keyCode == 13) document.getElementById('admin_login_submit').click()" />
                                            <div class="form-control-position"> <i class="las la-envelope"></i> </div>
                                        </fieldset>
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="password" class="form-control" id="admin_password" name="admin_password" placeholder="Enter Password" onkeydown="if (event.keyCode == 13) document.getElementById('admin_login_submit').click()" />
